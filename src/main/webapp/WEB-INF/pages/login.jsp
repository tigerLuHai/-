        ...
        <!-- <div class="control-group">
            ...
            <div class="controls">
                <div class="input-icon left">
                    ...
                    <input class="m-wrap placeholder-no-fix" type="tel" placeholder="验证码" id="logincheck" name="logincheck"/>
                    <input class="checkcode" type="button" name="checkcode" value="" style="background:none;height:30px;text-align: center;" onclick="getCode();"/>
                </div>
            </div>
        </div> -->
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.permission == "1") {
                    ...
                    window.location.href = "teacherClass?teacher1=" + result.teacher;
                } else if (result.permission == "3") {
                    window.location.href = "bossIndex";
                } else if (result.permission == "4") {
                    window.location.href = "projectProject?project=" + result.teacher;
                } else {
                    alert("用户名或密码错误");
                }
