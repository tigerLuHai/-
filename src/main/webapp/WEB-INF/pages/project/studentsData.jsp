...
<script type="text/javascript">
    ...
    function back() {
        ...
        window.location.href = "projectProject?project=" + project;
    }
    ...
    function add() {
        window.location.href = 'projectAddStudents';
    }
    ...
    function modify() {
        ...
        if (!!rows && !!rows[0]) {
            var row = rows[0];
            window.location.href = 'projectModify?studentsId=' + row.studentsId + '&classId=' + row.classId;
        } else {
            window.parent.showDiag("请选择一条数据", "noexec");
        }
    }
