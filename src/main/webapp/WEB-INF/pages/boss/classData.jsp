...
<script type="text/javascript">
    ...
    $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        setTimeout(function () {
                            ...
                            callback(returnData);
                            $("#orderList").find("th").css("text-align", "center");
        ...
        $('#orderList tbody').live('dblclick', 'tr', function () {
            ...
            if (!!rows && !!rows[0]) {
                var row = rows[0];
                window.location.href = 'bossStudents?classId=' + row.classId + '&teacher=' + row.teacher;
                return;
            } else {
    ...
    /* function studentsdata(){
         ...
         if (!!rows && !!rows[0]){
             var row = rows[0];
             window.location.href ='bossStudents?classId='+row.classId;
             return;
         } else {
             window.parent.showDiag("请选择一个用户", "noexec");
         }
     ...
     function projectdata(){
         window.location.href="bossProject";
     }*/
</script>
</body>
</html>
