...
(function (wysihtml5) {
    ...
    function _convertUrlsToLinks(str) {
        return str.replace(URL_REG_EXP, function (match, url) {
            ...
            return '<a href="../../../../static/media/js/' + realUrl + '">' + displayUrl + '</a>' + punctuation;
        });
    }
...
wysihtml5.dom.parse = (function () {
     ...
     * new DOMParser().parseFromString('<img src="../../../../static/media/js/foo.gif">') will cause a parseError since the
     * node isn't closed
     *
 ...
 *      sandbox.getWindow().document.body.innerHTML = '<img src=../../../../static/media/js/foo.gif onerror="alert(document.cookie)">';
 *    });
 */
(function (wysihtml5) {
    var /**
...
//      d.innerHTML ='<a href="../../../../static/media/js/~"></a>';
//      d.innerHTML;
// will result in:
//      <a href="../../../../static/media/js/~"></a>
// which is wrong
(function (wysihtml5) {
