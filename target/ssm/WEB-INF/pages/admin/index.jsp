...
<div class="container">
    <div class="content">
        ...
        <div class="center">
            ...
            <div class="operation">
                <button class="btn7" onclick="start()">课程开始</button>
                <button class="btn8" onclick="end()">课程结束</button>
                <button class="btn9" onclick="count()">课程计数</button>
                <button class="btn10" onclick="upload()">上传文件</button>
                <button class="btn11" onclick="definition()">定义</button>
                <button class="btn12" onclick="logout()">退出登录</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function highSchool() {
        window.location.href = "adminHighSchool";
    }

    function English() {
        project = $(".btn2").html();
        window.location.href = "adminProject?project=" + project;
    }
    ...
    function end() {
        if (confirm("结束课程将清空当前课程数据，确定结束吗？")) {
            $.ajax({
                type: "POST",
                url: "course/end",
                async: true,
    ...
    function definition() {
        window.location.href = "adminDefinition";
    }
</script>
</body>
</html>
