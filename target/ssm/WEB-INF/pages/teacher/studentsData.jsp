...
<div id="orderlistWraper">
    <div style="padding:3px">
        ...
        <a href="javascript:void(0);" class="easyui-linkbutton" plain="true" onclick="back()">返回首页</a>
        <a href="javascript:void(0);" class="easyui-linkbutton" plain="true" onclick="detail()" style="margin-left:5px">详情</a>
        <a href="javascript:void(0);" class="easyui-linkbutton" plain="true" onclick="add()"
           style="margin-left:5px">新增</a>
        <a href="javascript:void(0);" class="easyui-linkbutton" plain="true" onclick="modify()" style="margin-left:5px">修改</a>
        <a href="javascript:void(0);" class="easyui-linkbutton" plain="true" onclick="del()"
...
<script type="text/javascript">
    ...
    function back() {
        window.location.href = 'teacherClass?teacher1=' + teacher;
    }
    ...
    function add() {
        window.location.href = 'teacherAddStudents';
    }
    ...
    function detail() {
        ...
        if (!!rows && !!rows[0]) {
            var row = rows[0];
            window.location.href = 'teacherDetail?teacher=' + row.teacher + '&studentsName=' + row.studentsName + '&classId=' + row.classId;
        } else {
    ...
    function modify() {
        ...
        if (!!rows && !!rows[0]) {
            var row = rows[0];
            window.location.href = 'teacherModify?studentsId=' + row.studentsId + '&classId=' + row.classId;
        } else {
            window.parent.showDiag("请选择一条数据", "noexec");
        }
    }
